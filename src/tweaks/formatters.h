...
#define BUTTON_MAINUI_LABELS                          \
    {                                                 \
        "Контекстное меню", "Перекл. игр", "Возврат в игру" \
    }
#define BUTTON_INGAME_LABELS                                  \
    {                                                         \
        "Выкл", "Перекл. игр", "Выход в меню", "Быстрый доступ", "Меню RA" \
    }
...
#define BLUELIGHT_LABELS \
    {                       \
        "Легкий", "Умеренный", "Баланс", "Сильный", "Интенсивный"    \
    }

#define PWM_FREQUENCIES                                                                                                \
    {                                                                                                                  \
        "100 Hz", "200 Hz", "300 Hz", "400 Hz", "500 Hz", "600 Hz", "700 Hz", "По умолчанию", "900 Hz", "1000 Hz" \
    }
